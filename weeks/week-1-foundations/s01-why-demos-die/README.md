...
> [S2 · The deterministic/model boundary](../s02-code-model-boundary), which you run
> right after these.
...
```bash
npm run lab weeks/week-1-foundations/s01-why-demos-die/hook/naive.ts
```
...
```bash
npm run lab weeks/week-1-foundations/s01-why-demos-die/hook/real-traffic.ts
```
...
```bash
npm run lab weeks/week-1-foundations/s01-why-demos-die/hook/hardened.ts
```
...
```bash
npm run lab weeks/week-1-foundations/s01-why-demos-die/patterns/01-prompt-chaining.ts
```
...
```bash
npm run lab weeks/week-1-foundations/s01-why-demos-die/patterns/02-routing.ts
```
...
```bash
npm run lab weeks/week-1-foundations/s01-why-demos-die/patterns/03-parallelization.ts
```
...
```bash
npm run lab weeks/week-1-foundations/s01-why-demos-die/patterns/04-orchestrator-workers.ts
```
...
```bash
npm run lab weeks/week-1-foundations/s01-why-demos-die/patterns/05-evaluator-optimizer.ts
```
...
Continue to [S2 · The deterministic/model boundary](../s02-code-model-boundary), which
