...
**Week 4 · Agent Architecture and Security**
...
[`week-1 · s2 · workflow-vs-agent/as-agent.ts`](../../week-1-foundations/s02-code-model-boundary/workflow-vs-agent/as-agent.ts).
