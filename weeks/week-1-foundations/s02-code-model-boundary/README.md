...
```bash
npm run lab weeks/week-1-foundations/s02-code-model-boundary/workflow-vs-agent/as-workflow.ts
```
...
```bash
npm run lab weeks/week-1-foundations/s02-code-model-boundary/workflow-vs-agent/as-agent.ts
```
